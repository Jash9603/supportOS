...
export const ROPE2 = [
  ...
  },
  {
    ...
    type: 'resolved',
    reply: "Hi Priya! Here's how to cancel: 1. Go to Settings → Billing 2. Click 'Cancel Plan' 3. Select reason and confirm. Full guide → help.supportos.co/cancel. Done in 2 min!",
    resolvedIn: '5s',
  },
  {
  ...
  },
  {
    ...
    type: 'resolved',
    reply: "Hi Vivek! To download your invoice: 1. Go to Settings → Billing → Invoice History 2. Click the March row → Download PDF. Or visit → app.supportos.co/invoices",
    resolvedIn: '3s',
  },
]
...
export const ROPE3 = [
  ...
  },
  {
    ...
    type: 'resolved',
    reply: "Hi David! Try this: 1. Log out and log back in 2. Clear browser cache (Ctrl+Shift+Del) 3. Check Settings → Plan to confirm Pro is active. Guide → help.supportos.co/plan-upgrade",
    resolvedIn: '4s',
  },
  {
    ...
    type: 'resolved',
    reply: "Hi Hana! Try these steps: 1. Check hana.m@brand.co spam/junk 2. Whitelist no-reply@supportos.co 3. Try a different browser. Still stuck? → help.supportos.co/reset-password",
    resolvedIn: '5s',
  },
]
